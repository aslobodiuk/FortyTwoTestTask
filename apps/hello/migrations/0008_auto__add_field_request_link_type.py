...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Request.link_type'
        db.add_column(u'hello_request', 'link_type',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Request.link_type'
        db.delete_column(u'hello_request', 'link_type')
    ...
    models = {
        ...
        u'hello.request': {
            ...
            'link_type': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
